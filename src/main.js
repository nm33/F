...
const myBot = ['ua006bc54cce8702c8150523e0dd151ab'];
...
\n";
        ...
        if(txt === '!พี่เฟียร์' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === '!พี่เฟียร์' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"ผิดพลาด !");}
